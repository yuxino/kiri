# kiri interface demonstration

The animated preview and MP4 show interactions with the actual production frontend at `d3ebccbe86f1df4990651ce1e2569a60d88646fb`. The recording uses original sample documents and documentation-only substitutes for native API boundaries, not a native macOS/Windows session.
...
<!-- demo-pacing -->
Playback is paced at **2×** the original recording (42.08s → 21.04s). The MP4 and animated preview have matching timing; all scenes, captions and sample-data disclosures are retained.
<!-- /demo-pacing -->
